...
long TestWindow::onTestOutputDevice( FXObject*, FXSelector, void* )
{
	...
	{
		patchbay.AddInput( 1 );
		vInputSignals.push_back(
		    new ITAStreamFunctionGenerator( 1, dSampleRate, iBlockSize, ITAStreamFunctionGenerator::SAWTOOTH, ( 2 * 0 + 1 ) * fFundamentalFrequency, 1, true ) );
